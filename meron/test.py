...
morph_feature_dir = '/data/meron/features_fc6'
resnet_feature_dir = '/data/meron/features_resnet'
...
# This is the directory to write the CNN feature files
model_encoder = '/data/meron/models/encoder_cnn.h5'
...
test_x, train_x = meron_smart.prep_features(resnet_feature_dir)
encoder_model = con_feats.train_auto_encoder(train_x, test_x, input_dim=2048,
