...
meron_data_file='/data/meron/kenya_data/meron_images.csv'
...
#con_feats.extract_batch(smart_processed_dir, meron_data_file, smart_feature_dir, model_type='resnet50',
                        # n=1000)

# Read in VGG CNN features
meron_smart = MeronSmart()

test_x, train_x, _ = meron_smart.prep_features(feature_dir, n_params=nparams)
